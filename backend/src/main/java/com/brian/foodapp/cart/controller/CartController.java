package com.brian.foodapp.cart.controller;
...
public class CartController {
    ...
    @PostMapping("/items")
    public ResponseEntity<Response<?>> createCart(@RequestBody CartDTO cartDTO) {
    ...
    public ResponseEntity<Response<?>> deleteCart(@PathVariable Long cartItemId) {
